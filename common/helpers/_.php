...
class _
{
    ...
    public static function setModel($model, array $data)
    {
    ...
    {
        return Yii::$app->request->isGet ? true : false;
    }
    ...
    public static function removeCssFile($view, array $cssFile)
    {
        foreach ($cssFile as $file) {
            $view->registerJs("document.querySelector('link[href$=\"" . $file . "\"]').remove()", View::POS_HEAD);
        }
    }
}
